...
<h2><em>Designer</em></h2>
                      ...
                      <ul class="nav">
                         ...
                         <li><a href="doctor.jsp">Doctor</a></li>
                          <li><a href="alog.jsp">Central Server</a></li>
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="header-text">
            ...
            <em><form action="mreg.jsp" method="post">
           
            <div class="form-group">
                <input type="text" class="form-control item" id="username" name="name" placeholder="Username">
            </div>
            <div class="form-group">
                <input type="password" class="form-control item" id="password" name="password" placeholder="Password">
            </div>
            <div class="form-group">
                <input type="date" class="form-control item" id="dob"name="dob" placeholder="DOB">
            </div>
                 <div class="form-group">
                <input type="text" class="form-control item" id="email" name="email" placeholder="Email">
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" id="phone-number" name="contact" placeholder="Phone Number">
            </div>
            <div class="form-group">
