    ...
    <div class="container">
      <div class="row">
        ...
        <table style="width:600px; height:auto; " >
                ...
                <th>Update Details</th>
                 ...
                 <%
                  ...
                  Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/blockhealthcare","root","root");
                        PreparedStatement query=con.prepareStatement("Select * from request where pname='"+pname+"' and status='Permitted' ");
            ...
            <td><a href="kstatus1.jsp?pname=<%=pname%>&&keyy=<%=keyy%>" style=" text-decoration: none; color: darkmagenta;">Patient Details</a></td> 
