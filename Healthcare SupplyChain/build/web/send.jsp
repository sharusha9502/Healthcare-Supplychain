                ...
                <th>Send Key</th>
                 ...
                 <%
                  ...
                  Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/blockhealthcare","root","root");
                        PreparedStatement query=con.prepareStatement("Select * from request1 where pname='"+pname+"' and status='Permitted' and  pstatus='Accepted'");
                 ...
                 %>
                   <tr>
                    <td><%=pname%></td>   
                     <td><%=patient%></td> 
                     <td><%=status%></td>
                     <td style=" color:  red;"><%=pstatus%></td>
                     <td><a href="sendkey.jsp?pname=<%=pname%>&&patient=<%=patient%>&&key=<%=keyy%>&&dname=<%=dname%>&&sno=<%=sno%>"><%=estatus%></a></td>
                   </tr>
           <%}%> 
          </table>
     </center>
