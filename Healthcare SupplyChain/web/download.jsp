      ...
      <div class="row">
         ...
         <%
                  ...
                  Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/blockhealthcare","root","root");
                        PreparedStatement query=con.prepareStatement("Select * from request1  where sno='"+sno+"'");
         ...
         <form action='download1.jsp'>
                    ...
                    <br> <tr><td style='color:blue; font-size: 20px;'><strong >&ensp; &ensp;File Key: </strong></td><td><input type="text" name="keyy" ></td></tr>
                   <br> <tr><td align='center' colspan="2"><input type="submit" Value='View report' style="border-radius: 2px; width: 100px; height: 30px;  text-align: center;  ;background-color: lightblue; color:darkblue;"></td></tr>
           </form>
