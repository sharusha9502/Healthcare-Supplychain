...
<%
  String sno=request.getParameter("sno");
   ...
   PreparedStatement ps=con.prepareStatement(" update request1 set pstatus='Accepted' where sno='"+sno+"' ");
   ...
   out.println("</script>");
   RequestDispatcher rd=request.getRequestDispatcher("/viewrep.jsp");  
