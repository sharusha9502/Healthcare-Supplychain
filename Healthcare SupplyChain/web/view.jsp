                      ...
                      <ul class="nav">
                         ...
                         <li><a href="pauth.jsp">Authorize Patient</a></li>
                          <li><a href="genkey.jsp">Generate Key</a></li>
                           <li><a href="vpatient1.jsp">Trace Patient details</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 align-self-center">
          ...
          <header class="mb-4"><h1 class="tm-text-shadow" style=" margin-left: 84px;"align="center">User Report Encrypted </h1></header><br>
