      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="header-text">
            ...
            <h2><em>Patient Register Form </em></h2>
            <em><form action="pregaction.jsp" method="post">
           
            <div class="form-group">
                <input type="text" class="form-control item" id="username" name="pname" placeholder="Username" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="text" class="form-control item" name="contact" placeholder="Phone Number" pattern="[1-9]{1}[0-9]{9}"  required>
            </div>
            <div class="form-group">
                <input type="text" class="form-control item"  name="location" placeholder="Location"required>
            </div>
             <div class="form-group">
