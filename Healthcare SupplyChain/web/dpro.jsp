    ...
    <div class="container">
      <div class="row">
       ...
       <br>
                    ...
                    %>
                      <table>
                          <tr><td style=" color: purple;font-weight:bold;">Name:</td><td style=" color:black;font-weight:bold;"><%=r.getString("dname")%></td></tr>
                    
                    
                    <tr><td style=" color: purple;font-weight:bold;">Hospital Name:</td><td style=" color:black;font-weight:bold;"><%=r.getString("hname")%></td></tr>
                    
                     <tr><td style=" color: purple;font-weight:bold;">Specialist:</td><td style=" color:black;font-weight:bold;"><%=r.getString("spec")%></td></tr>
