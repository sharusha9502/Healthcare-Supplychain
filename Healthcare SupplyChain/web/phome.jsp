          ...
          <div class="row">
              <div class="col-12">
                  <nav class="main-nav">
                   ...
                   <li><a href="send.jsp">Logout</a></li>
                      </ul>        
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          ...
          <div class="header-text">
              <h1 style=" font-weight: bolder; font-size:53px;  margin-top:130px; ">  Welcome <%=pname%> </div>
             <div class="col-lg-6">
          <div class="">
        ...
        <div class="col-lg-6">
          <div class="right-image">
              <img src="assets/images/phome.avif" width="200px;" height="400px;"alt="">
          </div>
        </div>
      </div>
    </div>
