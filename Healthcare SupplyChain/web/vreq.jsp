             ...
             <tr> 
                 ...
                 <%
                  ...
                  Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/blockhealthcare","root","root");
                        PreparedStatement query=con.prepareStatement("Select * from upload where dname='"+dname+"' ");
                 ...
                 %>
                   <tr>
                    <td><%=pname%></td>   
                     <td><%=patient%></td> 
                     <td><a href="req.jsp?pname=<%=pname%>&&patient=<%=patient%>&&dname=<%=dname%>&&keyy=<%=keyy%>&&file=<%=file%>">Make a Request</a></td>
